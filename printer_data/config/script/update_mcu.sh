...
#echo ""
python3 ~/katapult/scripts/flashtool.py -i can0 -u 59d755ed9e3b -f ~/firmware/ebb36_katapult.bin
sleep 2
python3 ~/katapult/scripts/flashtool.py -i can0 -u 59d755ed9e3b -f ~/firmware/ebb36_klipper.bin
...
sleep 2
python3 ~/katapult/scripts/flashtool.py -d /dev/serial/by-id/usb-katapult_stm32g0b1xx_08002B000C504B5735313920-if00 -f ~/firmware/manta_m5p_katapult.bin
sleep 2
python3 ~/katapult/scripts/flashtool.py -d /dev/serial/by-id/usb-katapult_stm32g0b1xx_08002B000C504B5735313920-if00 -f ~/firmware/manta_m5p_klipper.bin
